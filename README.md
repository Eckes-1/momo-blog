...
<div align="center">
    ...
    <p>以坚实之根，绽放思想之光 — 使用 <a href="https://astro.build/">Astro</a> 搭建的个人博客</p>
    <small><ins>简体中文</ins></small> <small><a href="./doc/README_en.md">English</a></small>
</div>

## ✨ 特性

LiHui Blog — "栗"取坚实扎根之意，"辉"取光芒绽放之意。以坚实之根，绽放思想之光。
...
参考[配置指南](./doc/config_zh-cn.md)，详细信息可以访问 [LiHui Blog](https://eckes.de5.net/intro/config)，阅读对应文章获取详细信息。

## 📚 更新

参考[更新指南](./doc/release_zh-cn.md)，介绍如何更新项目，详细信息可以访问 [LiHui Blog](https://eckes.de5.net/intro/release)。
