...
如果需要启用评论功能，需要先部署后端评论系统，具体参考 lihui-blog 仓库。
...
```css
:root {
    --lihui-text-color: #d51111;            /* 文字颜色 */
    --lihui-button-border-color: #e5e5e5;   /* 按钮边框颜色 */
    --lihui-button-hover-bg-color: #f5f5f5; /* 按钮背景颜色（hover 状态）*/
    --lihui-link-color: #003b6e;            /* 链接颜色 */
}
/* 暗色模式 */
[data-theme="dark"] {
